...
<div class="container mt-5">
    <div class="row">
        <div class="col-12">
        	...
        	<h3 class="outside_2">*{{$shipments->barcode}}*</h3>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <h2 style="margin-left: 80px;">{{$shipments->barcode}}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        @endphp
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <p>{{$shipments->reference_number}}</p>
                        </div>
                    </div>
                </div>
            </div>
			        ...
			        <div class="row no-gutters">
			            ...
			            <div class="col-3">
			                <div class="box1">
                                ...
                                @php
                                $cityCode = null;
                                if ($shipments->city !== null) {
                                    $city = DB::table('citys')->where('id', $shipments->city)->first();
                                    if ($city) {
			            ...
			            <div class="col-3">
			                <div class="box1">
			                	...
			                	<h5 class="text-center">{{$shipments->service_type}}</h5>
			                </div>
			            </div>
			            ...
			            <div class="col-4">
			                ...
			                <h5 class="text-center">{{$shipments->cod}}.00/-.00/-</h5>
			                </div>
			            </div>
			            ...
			            <div class="col-4">
			                ...
			                <h5 class="text-center">{{$shipments->no_of_peices}}</h5>
			                </div>
			            </div>
			...
			<div class="card-group">
			        ...
			        <div class="row no-gutters">
			            <div class="col-4">
			                <div class="box1">
                                @php
                                $shippers = null;
                                if ($shipments->shipper_code !== null) {
                                $shippers = DB::table('shippers')->where('id', $shipments->shipper_code)->first();
                                }
                                @endphp
			            ...
			            <div class="col-4">
			                <div class="box1">
			                	<p class="text-center">{{$shipments->order_date}}</p>
			                </div>
			            </div>
			    ...
			    <div class="card2">
			        <div class="box3">
                        <div class="rotated-text1 mb-3">{!! DNS1D::getBarcodeHTML("$shipments->reference_number", 'C93' ,1  ,50 ) !!}</div>
			        </div>
			    </div>
			</div>
			            ...
			            <div class="col-12">
			                ...
			                <div class="box6">
			                	<div class="row">
			                		...
			                		<div class="col-9">
                                        <h5>{{$shipments->reciver_name}}</h5>
                                        @php
                                        $country_reciver = DB::table('countrys')->where('id', $shipments->country)->first();
                                        $city_reciver = DB::table('citys')->where('id', $shipments->city)->first();
                                        $area_reciver = DB::table('areas')->where('id', $shipments->area)->first();
                                        @endphp
                                        <h5>{{ $shippers ? $shipments->street_address : 'Unknown Address' }} , {{ $area_reciver ? $area_reciver->name : 'Unknown Area' }} , {{ $city_reciver ? $city_reciver->name : 'Unknown City' }} , {{ $country_reciver ? $country_reciver->name : 'Unknown Country' }}</h5>
			                			 <h5>{{ $area_reciver ? $area_reciver->name : 'Unknown Area' }}</h5>
			                			 <h5>{{ $city_reciver ? $city_reciver->name : 'Unknown City' }}</h5>
			                			 <h5>{{$shipments->mobile_1}}</h5>
			                			 <h5>{{$shipments->mobile_2}}</h5>
			                		</div>
			                	</div>
			                </div>
			            </div>
			            ...
			            <div class="col-12">
			                <div class="box1">
			                	<div class="row">
			                		...
			                		<div class="col-6">
			                			 <h5>{{$shipments->instruction}}</h5>
			                			 <h5>{{$shipments->account_name}}</h5>
			                			 <h5>{{$shipments->reference_number}}</h5>
			                			 <h5>{{ $current_time }}</h5>
			                		</div>
