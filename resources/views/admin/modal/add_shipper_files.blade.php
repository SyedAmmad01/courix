...
<div class="modal fade" id="AddShipperModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Shipper Files</h5>
            </div>
            <form class="forms-sample" id="ShipperFile">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <button type="button" class="btn btn-warning btn-sm" id="browserBtn"><i class="fa fa-upload"></i>
                            Browser</button>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-warning btn-sm" data-dismiss="modal">Dismiss</button>
...
<script>
    $(document).ready(function() {
        ...
        $("#ShipperFile").on("submit", function(e) {
            e.preventDefault();
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('/admin/shipper_files/shipper_files_save') }}",
                data: formData,
                processData: false,
                contentType: false,
