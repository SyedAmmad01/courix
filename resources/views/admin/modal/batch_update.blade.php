...
<!-- Modal-->
<div class="modal fade" id="batch_update" tabindex="-1" role="dialog"aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="exampleModalLabel">Batch Update</h2>
            </div>
            <form class="needs-validation" id="BatchUpdateForm" novalidate>
                <div class="modal-body">
                    <input type="hidden" id="batchUpdateModalContent" name="batchUpdateModalContent" readonly>
                    <input type="hidden" id="u_id" name="id" readonly>
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
...
<script>
    $(document).ready(function() {
        ...
        $("#BatchUpdateForm").on("submit", function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.shipment.batch_update') }}",
                data: formData,
                processData: false,
                contentType: false,
