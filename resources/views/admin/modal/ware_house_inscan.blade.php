...
<div class="modal fade" id="warehouse_inscan_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form action="">
                    <div class="form-group">
                        ...
                        <div class="input-group m-b-10">
                            ...
                            <select class="form-control kt-select2 select2" id="" name="" style="width:86%;">
                                <option value="">WH00001 | COURIX - H/O</option>
                                <option value="">WH00001 | COURIX - H/O</option>
                            </select>
                        </div>
                    </div>
