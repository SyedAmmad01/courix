...
<div class="modal fade bd-example-modal-lg" id="driverShowModalEdit" tabindex="-1" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <div class="input-group m-b-10">
                                    ...
                                    <select class="form-control kt-select2 citys" id="d-city" name="city"
                                        required>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <div class="input-group m-b-10">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="fas fa-lg fa-fw fa-map-marker-alt"></i></span></div>
                                    <select class="form-control kt-select2 zones" id="d-zones"
                                        name="zones" required>
